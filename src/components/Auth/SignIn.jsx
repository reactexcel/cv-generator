...
import SignInImage from '../../assets/sigin.svg'
  ...
  <section className="min-h-screen flex items-stretch text-white ">
    ...
    >
      ...
      <div className="w-full py-6 z-20">
        ...
        {/* <img src={SignInImage} style={{width:'10px',color:"white",backgroundColor:"w"}} /> */}
        <img src={SignInImage}  style={{width:'49px',color:"white",backgroundColor:"white" }} />
        ...
        <form onSubmit={formik.handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
          <div className="pb-2 pt-4">
            ...
            />
              ...
              <Typography color="error" sx={{textAlign:'left',pl:"7px"}}>{formik.errors.email}</Typography>
            )}</div>
          <div className="pb-2 pt-4">
            <input
              className="block w-full p-4 text-lg rounded-sm bg-black"
            ...
            />
              ...
              <Typography color="error" sx={{textAlign:'left',pl:"7px"}}>{formik.errors.password}</Typography>
            )}</div>
